...
var compact_state_predicates_1 = require("./compact-state-predicates");
...
function isNeighborUnreachable(board, posn) {
    return !(posn.row < board.length && posn.row > -1)
        ...
        || compact_state_predicates_1.PRED_isCSpaceACUnusable(board[posn.row][posn.col])
        || compact_state_predicates_1.PRED_isCSpaceACHole(board[posn.row][posn.col])
        || compact_state_predicates_1.PRED_isCSpaceACPenguin(board[posn.row][posn.col])
